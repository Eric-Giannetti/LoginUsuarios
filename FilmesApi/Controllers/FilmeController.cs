...
namespace FilmesAPI.Controllers
{
    ...
    public class FilmeController : ControllerBase
    {
        ...
        {
            List<ReadFilmeDto> readFilmes = _filmeService.RecuperarFilmes(classificacaoEtaria);
            if (readFilmes != null) return Ok(readFilmes);
            return NotFound();
        }
        ...
        {
            ReadFilmeDto readFilme = _filmeService.RecuperarFilmePorId(id);
